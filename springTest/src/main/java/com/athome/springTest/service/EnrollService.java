...
public class EnrollService {
    ...
    public Enrollments enroll(int academicCourse_id, int user_id) {
        ...
        Users user = userRepository.findById(user_id)
                .orElseThrow(() -> new IllegalArgumentException("Not pound this user id: " + user_id));

        Enrollments en = new Enrollments();
        en.setAcademicCourse(academicCourse);
        en.setUsers(user);
        en.setEnrolledAt(new Date());
